...
class Area_Pedagogica : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_area_pedagogica)
        ...
        dbViewModel.getLibriBySettore("Pedagogico")?.observe(this, Observer{ libri -> libroListAdapter.submitList(libri)
        })
