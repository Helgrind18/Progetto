...
class Area_Giuridica : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_area_giuridica)
        ...
        dbViewModel.getLibriBySettore("Giuridico")?.observe(this, Observer{ libri -> libroListAdapter.submitList(libri)
        })
